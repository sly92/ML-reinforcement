...
class TensorboardInstrumentedTicTacToeRunner(GameRunner):
...
if __name__ == "__main__":
    ...
    score, round_sum_time, sum_action_duration = TensorboardInstrumentedTicTacToeRunner(DeepQLearningAgent(9,9),
                                                                                        DeepQLearningAgent(9,9),
                                                                                        log_dir_root="./logs/" + battle_name,
                                                                                        print_and_reset_score_history_threshold=100).run(
        num_games)
